...
from django_school_management.academics.models import Department, Term, AcademicSession, Subject, Batch
...
class UserGuideView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        check_models = [Department, Term, AcademicSession, Subject, SubjectGroup, Batch]
        models = []
