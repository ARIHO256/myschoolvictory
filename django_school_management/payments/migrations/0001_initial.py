    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='admission_pay_verifications', to=settings.AUTH_USER_MODEL)),
            ],
            options={
